  ...
  return (
    <div className=" text-center z-1">
      <div className="grid grid-cols-6 max-md:grid-cols-1  gap-4 pt-[5rem] text-center ">
        <motion.div
          className="col-span-3 row-span-2 max-md:col-span-2 "
          initial={{ opacity: 0, x: "-50%" }}
          whileInView={{ x: 0, opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.5 }}
        >
          <Card className="col-span-3 row-span-2 max-md:col-span-2 h-full text-center flex-col flex  justify-center items-center ">
        ...
        <motion.div
          className="col-span-3 row-span-1 max-md:col-span-2 text-center flex-col flex justify-center items-center"
          initial={{ opacity: 0, x: "50%" }}
          whileInView={{ x: 0, opacity: 1 }}
          viewport={{ once: true }}
        ...
        <motion.div
          className="lg:col-span-4 md:col-span-6 max-md:col-span-2 text-center flex-col flex justify-center items-center"
          initial={{ opacity: 0, x: "-50%" }}
          whileInView={{ x: 0, opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5, delay: 0.25 }}
